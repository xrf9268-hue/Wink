...
- Migration and mirror repair **copy bytes**; they never re-encode. `AppShortcut.CodingKeys` drops JSON members it does not model, so a round trip silently discards data a newer build wrote.
