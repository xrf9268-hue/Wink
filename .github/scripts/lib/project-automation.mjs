...
const runtimeSensitivePatterns = [
  ...
  /^Sources\/Wink\/Services\/ApplicationObservation\.swift$/,
  /^Sources\/Wink\/Services\/CarbonHotKeyProvider\.swift$/,
  /^Sources\/Wink\/Services\/EventTapCaptureProvider\.swift$/,
  /^Sources\/Wink\/Services\/EventTapManager\.swift$/,
  /^Sources\/Wink\/Services\/LaunchAtLoginService\.swift$/,
  /^Sources\/Wink\/Services\/ShortcutCaptureCoordinator\.swift$/,
  /^Sources\/Wink\/Services\/ShortcutManager\.swift$/,
  /^Sources\/Wink\/Services\/SkyLightBridge\.swift$/,
  /^Sources\/Wink\/AppController\.swift$/,
  /^Sources\/Wink\/AppDelegate\.swift$/,
  /^Sources\/Wink\/main\.swift$/,
